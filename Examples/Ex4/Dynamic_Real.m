...
w=mvnrnd([zeros(1,Auxdata.intermediateData.number_of_states-1)],Auxdata.Kalman.Q_Kalman);
Dq=dq;
Dq(1:Auxdata.intermediateData.number_of_states-1)=Dq(1:Auxdata.intermediateData.number_of_states-1)+w;
